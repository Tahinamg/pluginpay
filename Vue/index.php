...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-6 col-sm-6 col-md-6 col-lg-6 ban" style="margin-top: 5%;">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-center">
                    <div class="d-flex flex-column align-content-center justify-content-center mx-1 paiementitem">
                    
                        <img  width="100px" height="50px" src="Image/mvolaa.png" alt="mvola"/>
                            
                        <em class="text-warning text-center">via mvola</em>
                    </div>
        
                    <div class="d-flex flex-column paiementitem mx-1">
                        
                        <img width="100px" height="50px" src="Image/money-check.svg" alt="cheque"/>
                        <em class="text-primary text-center">par cheque</em>
                    </div>
        
                    <div class="d-flex flex-column paiementitem mx-1">
                        <img width="100px" height="50px" src="Image/money-bill.svg" alt="espece"/>
        
                        <em class="text-danger text-center">par espece</em>
                    </div>
        
                    <div class=" d-flex flex-column paiementitem mx-1">
                        <img width="100px" height="50px" src="Image/arrow-right.svg" alt="Virement"/>
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                <img class="justify-content-center" src="Image/test.jpg"/>
            </div>
        </div>
    </div>
