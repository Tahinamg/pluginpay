...
if(isset($_POST['motif'])){
    switch ($_POST['motif']) {
        case 'inscription':
            $data=array($_POST['matricule'],$_POST['idcheque']);
            $comptable->ValiderInscriptionViaCheque($data[0],$data[1]);
            ...
            break;
        case 'ecolage' :
            $data=array($_POST['quantite'],$_POST['matricule'],$_POST['idcheque']);
            $comptable->ValiderEcolageViaCheque($data[0],$data[1],$data[2]);
        ...
        case 'droit examen semestriel' : 
            $data=array($_POST['matricule'],$_POST['idcheque']);
            $comptable->ValiderDroitExamenViaCheque($data[0],$data[1]);
        ...
        case 'Droit de soutenance' :
            $data=array($_POST['matricule'],$_POST['idcheque']);
            $comptable->ValiderSoutenanceViaCheque($data[0],$data[1]);
            ...
            break;
        case 'repechage' :
            $data=array($_POST['idetudiants'],$_POST['idcheque']);
            $comptable->ValiderRepechageViaCheque($data[0],$data[1]);
