...
if(isset($_POST['motif'])){
    switch ($_POST['motif']) {
        case 'inscription':
            $data=array($_POST['matricule'],$_POST['idversement']);
            $comptable->ValiderInscriptionViaVersement($data[0],$data[1]);
            ...
            break;
        case 'ecolage' :
            $data=array($_POST['quantite'],$_POST['matricule'],$_POST['idversement']);
            $comptable->ValiderEcolageViaVersement($data[0],$data[1],$data[2]);
        ...
        case 'droit examen semestriel' : 
            $data=array($_POST['matricule'],$_POST['idversement']);
            $comptable->ValiderDroitExamenViaVersement($data[0],$data[1]);
        ...
        case 'Droit de soutenance' :
            $data=array($_POST['matricule'],$_POST['idversement']);
            $comptable->ValiderSoutenanceViaVersement($data[0],$data[1]);
            ...
            break;
        case 'repechage' :
            $data=array($_POST['idetudiants'],$_POST['idversement']);
            $comptable->ValiderRepechageViaVersement($data[0],$data[1]);
