...
class VersementManager{
 //UPLOAD 
    ...
    public function setVersement(Versement $versement){
        ...
        $sql=$this->db->prepare("INSERT INTO VERSEMENT (IDVERSEMENT, NBORDEREAUX, DATY, AGENCE, IDETUDIANTS, MOTIF, ETAT, DECISION, DATESERVER, MONTANT,OBSERVATION,DATEVERSEMENT,DATEVALIDATION,TEMPSVALIDATION) VALUES (DEFAULT, :nbordereaux,:daty,:agence,:idetudiants,:motif, :etat, :decision, CURRENT_TIMESTAMP,:montant,:observation,:dateversement,:datevalidation,:tempsvalidation)");
