...
class WesternManager{
    ...
    public function setWestern(Western $union){
        $statement=$this->db->prepare("INSERT INTO `WESTERN` VALUES(DEFAULT,:nsuivi,:nomexp,:montantwestern,:montant,:motif,:etat,:decision,CURRENT_TIMESTAMP,:idetudiants,:observation,:datevalidation,:tempsvalidation)");
